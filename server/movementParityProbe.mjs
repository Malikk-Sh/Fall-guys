...
function main() {
  ...
  const lines = [
    ...
    `                 p50  ${metrics.freeTrajectoryError.p50.toFixed(4)}   (порог ≤ ${policy.maxFreeTrajectoryErrorP50})`,
    `                 p95  ${metrics.freeTrajectoryError.p95.toFixed(4)}   (порог ≤ ${policy.maxFreeTrajectoryErrorP95})`,
