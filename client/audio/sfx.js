...
export class Sfx {
  ...
  // Возврат и закрытие идут вниз по высоте, поэтому даже без взгляда на экран не путаются с
  // подтверждением. Один короткий glide не создаёт хвоста поверх спокойной музыки меню.
  uiBack() {
    this.engine.playTone({ freq: [760, 420], type: 'triangle', duration: 0.14, volume: 0.11 });
  }
