...
- [`NETCODE-MIGRATION.md`](NETCODE-MIGRATION.md) — что переведено на серверный авторитет, как
  устроены ворота готовности и лизы на матч, и почему полный серверный авторитет движения снят с
  плана: клиент остаётся авторитетом движения, сервер — допустимости и результата.
