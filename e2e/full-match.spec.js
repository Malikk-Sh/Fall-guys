...
// Запас на прохождение. Бот проходит выбранную трассу примерно за полминуты; потолок взят с большим
// запасом, потому что падение возвращает на чекпоинт и сегмент приходится проходить заново.
